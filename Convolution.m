...
subplot(3,1,1),stem(x_id,x),title('input signal'),axis([idmin idmax -10 10])
subplot(3,1,2),stem(h_id,h),title('impulse response signal'),axis([idmin idmax -10 10])
subplot(3,1,3),stem(id_y,y),title('output signal'),axis([idmin idmax -10 10])